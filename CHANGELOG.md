...
## [1.12.6](https://github.com/harshsandhu44/muxx/compare/v1.12.5...v1.12.6) - 2026-07-29

### Other

- update Cargo.lock dependencies

## [1.12.5](https://github.com/harshsandhu44/muxx/compare/v1.12.4...v1.12.5) - 2026-06-29

### Other

- update Cargo.lock dependencies

## [1.12.4](https://github.com/harshsandhu44/muxx/compare/v1.12.3...v1.12.4) - 2026-06-18

### Fixed

- sync tmux-resurrect snapshot after session mutations ([#64](https://github.com/harshsandhu44/muxx/pull/64))
...
## [1.12.1](https://github.com/harshsandhu44/muxx/compare/v1.12.0...v1.12.1) - 2026-05-17
...
- *(connect)* warn when reused session path differs from requested directory

### Fixed

- *(connect)* use alias name as session name when resolving config alias
